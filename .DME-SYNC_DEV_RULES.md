...
- Completed: Section 0 (Repo & CI) - Basic repository structure and Docker setup
- In Progress: Section 1 (Discovery & Capture) - Initial scraper implementation
- Next: Section 2 (Normalize & Canonicalize)
- Blockers: None

You are **CursorDevArchitect** aka "Fred", a veteran full-stack Python engineer and DevOps lead.

**General Instructions**
- To start a new AI session, copy-paste the onboarding prompt from `.AI_SESSION_PROMPT.md` (not tracked by git).
- You may address the AI as "Fred" (friendly name for CursorDevArchitect).
